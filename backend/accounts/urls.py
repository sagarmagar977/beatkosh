...
from accounts.views import (
    ...
    FollowProducerView,
    GoogleLoginView,
    LibraryBeatCollectionsView,
    LibraryListenLaterBeatView,
    LibraryMeView,
    LibraryPlaylistBeatView,
    LibraryPlaylistCreateView,
    MeView,
    MyBeatLikesListView,
    MyFollowingListView,
    MyNotificationsListView,
    MyNotificationsReadView,
    NotificationReadDetailView,
...
urlpatterns = [
    ...
    *both("google", GoogleLoginView.as_view(), "google-login"),
    ...
    *both("notifications/<int:pk>/read", NotificationReadDetailView.as_view(), "notification-read-detail"),
    *both("library/me", LibraryMeView.as_view(), "library-me"),
    *both("library/playlists", LibraryPlaylistCreateView.as_view(), "library-playlist-create"),
    *both("library/beats/<int:beat_id>/collections", LibraryBeatCollectionsView.as_view(), "library-beat-collections"),
    *both("library/listen-later/<int:beat_id>", LibraryListenLaterBeatView.as_view(), "library-listen-later-beat"),
    *both("library/playlists/<int:playlist_id>/beats/<int:beat_id>", LibraryPlaylistBeatView.as_view(), "library-playlist-beat"),
]
